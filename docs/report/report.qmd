---
title: "EH Dashboard Analytics Report"
subtitle: "DigitXL Internship Project"
...
This project was undertaken as part of a data analytics internship at **DigitXL**, a Melbourne-based digital consultancy specialising in *performance marketing*, *analytics*, and *data strategy*.

The client, referred to as **EH**, is a luxury wellness and retreat brand aiming to enhance its digital lead generation and improve booking conversions across its website.

The project’s objective was to design an **integrated analytics ecosystem** combining **Google Analytics 4 (GA4)** behavioural data with internal lead and sales records to uncover performance gaps across EH’s marketing funnel.

Using **R** for data cleaning and transformation, **Google Sheets** for data blending, and **Looker Studio** for dashboard development, a unified reporting framework was established that automated weekly insights on *channel performance*, *user engagement*, and *conversion rates*.

The resulting dashboard revealed critical insights, including **significant drop-offs** from the homepage to retreat and booking pages, **inconsistent lead qualification patterns**, and **underperforming CTAs** impacting conversions.

These findings informed the **A/B testing and UX redesign process** for the client’s website.

The final outcome is a **reproducible**, **scalable dashboard framework** that empowers EH to make *data-driven marketing and design decisions*, while also demonstrating practical skills in **analytics engineering**, **data visualisation**, and **digital performance evaluation**.
...
To address this: - The project mapped the **entire digital user journey** using GA4 event tracking and Looker Studio funnel charts.
...
These figures help pinpoint where micro-interventions can make the biggest impact.  
For example:  
...
## GA4 Data Insights Dashboard — Understanding User Behaviour
...
**Business Impact:**  
This project has already begun to influence EH’s strategic decision-making.  
The unified dashboard empowers the management team to:  
